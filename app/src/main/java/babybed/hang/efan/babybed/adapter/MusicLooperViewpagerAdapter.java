...
public class MusicLooperViewpagerAdapter extends PagerAdapter {
    private int[] simg = {R.mipmap.img_music_first, R.mipmap.img_music_second, R.mipmap.img_music_third};
    private Context mContext;

    public MusicLooperViewpagerAdapter(Activity activity) {
        mContext = activity;
    }
