...
package babybed.hang.efan.babybed.service;
...
public class BluetoothChatService {
    ...
    private synchronized void setState(int state) {
        ...
        // 给新状态的处理程序，界面活性可以更新
        mHandler.obtainMessage(BedFragment.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(BedFragment.MESSAGE_DEVICE_NAME);
        Bundle bundle = new Bundle();
        bundle.putString(BedFragment.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        // 发送失败的信息带回活动
        Message msg = mHandler.obtainMessage(BedFragment.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BedFragment.TOAST, "无法连接装置");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(BedFragment.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(BedFragment.TOAST, "装置连接丢失");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class ConnectedThread extends Thread {
                ...
                try {
                    ...
                    if(bytes>0)
                    {
                        ...
                        if (str.endsWith("0D")) {
                            ...
                            mHandler.obtainMessage(BedFragment.MESSAGE_READ, buffer1.length, -1, buffer1)
                                    .sendToTarget();
                            str1 = "";
                        }
                        else{
                            if (!str.contains("0A")) {
                                ...
                                if (!str.equals("0A")&&str.endsWith("0A")) {
                                    mHandler.obtainMessage(BedFragment.MESSAGE_READ, bytes, -1, buffer)
                                            .sendToTarget();
                                }
                            }
                        }
        ...
        public void write(byte[] buffer) {
            try {
                ...
                // 把消息传给UI
                mHandler.obtainMessage(BedFragment.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
