package babybed.hang.efan.babybed.weight.scaleruler.view;
...
import babybed.hang.efan.babybed.weight.scaleruler.utils.TextUtil;
...
public class DecimalScaleRulerView extends View {
     ...
     * 设置尺寸
     *
     * @param itemSpacing 刻度间隔距离
     * @param maxLineHeight 字体所在最长标尺长度
     * @param middleLineHeight 中标尺刻度
     * @param minLineHeight 短标尺长度
     * @param textMarginTop 字体距离顶部距离
     * @param textSize 字体尺寸
     */
