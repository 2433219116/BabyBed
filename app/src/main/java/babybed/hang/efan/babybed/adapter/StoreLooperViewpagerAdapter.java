...
public class StoreLooperViewpagerAdapter extends PagerAdapter {
    private int[] simg = {R.mipmap.img_store_first, R.mipmap.img_store_second, R.mipmap.img_store_third};
    private Context mContext;

    public StoreLooperViewpagerAdapter(Activity activity) {
        mContext = activity;
    }
